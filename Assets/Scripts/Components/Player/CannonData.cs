...
/*
    Aqui vamos a almacenar la posicion del canyon  TODO: Esta clase igual sobra.
*/
...
public struct CannonData : IComponentData
{
    ...
    public LinkedEntityGroup linked;
    public Entity ammo; // Referencia a la municion.
    public Entity player; // Refrencia al jugador.
}
